...
if __name__ == '__main__':
    ...
    (
        ...
        .add_label("Host:")
        .add_entry("string:host_var", "127.0.0.1", width=10)
        .add_label("Port:")
        .add_entry("int:port_var", "8080", width=10)
        ...
        .add_entry("int:left_score_var", "0", justify='center', width=5)
        .add_radiobutton("<<<", "string:event_var", "award_pot_to_left")
        .add_entry("int:pot_score_var", "0", justify='center', width=5)
        .add_radiobutton(">>>", "string:event_var", "award_pot_to_right")
        .add_entry("int:right_score_var", "0", justify='center', width=5)
        .end_frame()
